    ...
    with when("@0.16:"):
        ...
        depends_on(
            ...
            patches=[
                ...
                # NCMesh partition fixes; not yet in MFEM 4.10. Applied directly
                # from the upstream PR range, which uses FlipIndexSign (present
                # as of 4.10). Remove once merged upstream and MFEM is bumped.
                patch(
                    "https://github.com/mfem/mfem/compare/"
