...
function gen_slab_guide(;
    ...
    on_plane(x0, y0, z0, x1, y1, z1) = last.(
        gmsh.model.getEntitiesInBoundingBox(
            x0 - eps,
            y0 - eps,
            z0 - eps,
...
gen_slab_guide(
    filename=get(ARGS, 1, joinpath(@__DIR__, "slab_waveguide.msh")),
