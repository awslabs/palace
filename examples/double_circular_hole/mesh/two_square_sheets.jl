...
L_outer = 20.0          # Outer box size
sheet_size = 4.0        # Side length of each square sheet
hole_radius = 0.8       # Radius of circular holes  
sheet_separation = 6.0  # Distance between sheet centers

# Set mesh sizes for different regions
mesh_size_coarse = 3.0  # Box surfaces (very coarse)
mesh_size_medium = 0.5  # Sheet region
...
# Write mesh file
gmsh.write("two_square_sheets2.msh")
