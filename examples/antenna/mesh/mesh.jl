...
"""
    generate_antenna_mesh(;
        ...
        outer_boundary_radius::Real = 2.4arm_length,
        verbose::Integer = 5,
        gui::Bool = false
    )
...
function generate_antenna_mesh(;
    ...
    # sphere, the two 3D cylinders, and the 2D rectangle. Then, we fragment everything out
    # of the 3D sphere. We need to fragment to ensure that the mesh is conformal and that
    ...
    println()
    println("Finished generating mesh. Physical group tags:")
