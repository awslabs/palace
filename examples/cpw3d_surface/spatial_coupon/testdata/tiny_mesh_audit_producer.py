...
def prism_tube_record(mesh, tubes, tube_count):
    ...
    return {"Rule": "fixture", "InnerSize": inner, "GrowthRatio": ratio,
            ...
            "LayerThickness": {"Minimum": tubes["lc_tangent"], "P50": tubes["lc_tangent"],
                               "Maximum": tubes["lc_tangent"], "MaximumNeighbourRatio": 1.0,
                               "AchievedOverPrescribedP50Range": [1.0, 1.0],
                               "LayersBelowTangentialSizeOverGrowthRatio": 0},
            ...
            "Section": {"Rings": rings, "RingSizes": [inner * ratio**k for k in range(rings)],
                        ...
                        "Kind": "fabricated", "TubesPerSide": 2, "ThinCutoff": None},
