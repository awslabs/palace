...
proxy_gridfunction_seconds="$(metric proxy_gridfunction_seconds)"
proxy_paraview_bytes="$(metric proxy_paraview_bytes)"
proxy_gridfunction_bytes="$(metric proxy_gridfunction_bytes)"
...
PROXY_GRIDFUNCTION_SECONDS=$proxy_gridfunction_seconds
PROXY_PARAVIEW_BYTES=$proxy_paraview_bytes
PROXY_GRIDFUNCTION_BYTES=$proxy_gridfunction_bytes
...
printf 'METRIC proxy_gridfunction_seconds=%s\n' "$proxy_gridfunction_seconds"
printf 'METRIC proxy_paraview_bytes=%s\n' "$proxy_paraview_bytes"
printf 'METRIC proxy_gridfunction_bytes=%s\n' "$proxy_gridfunction_bytes"
