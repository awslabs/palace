...
class PalaceSolver:
    ...
    def __init__(self, palace_executable: Optional[str] = None):
        ...
        if not self.executable:
            raise RuntimeError("Palace executable not found. Please install Palace or specify path.")
    ...
    def run(self, config_file: str, output_dir: Optional[str] = None,
            num_procs: Optional[int] = None, **kwargs) -> subprocess.CompletedProcess:
        """
