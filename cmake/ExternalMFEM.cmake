...
int main() { return 0; }
      ...
      if(NOT PALACE_CUDSS_OPENMPI_COMM_LIB)
        message(FATAL_ERROR
          "Could not find the bundled cuDSS Open MPI communication layer under CUDSS_DIR; "
          "set CUDSS_DIR to the cuDSS installation or CUDSS_COMM_LIB to the layer library"
        )
      endif()
