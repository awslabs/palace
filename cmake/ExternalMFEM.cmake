...
if(PALACE_BUILD_EXTERNAL_DEPS)
  ...
  if(PALACE_WITH_PETSC)
    list(APPEND MFEM_DEPENDENCIES petsc)
  endif()
else()
...
list(APPEND MFEM_OPTIONS
  ...
  "-DMFEM_USE_PETSC=${PALACE_WITH_PETSC}"
