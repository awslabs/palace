...
if(TARGET enzyme)
  list(APPEND PALACE_DEPENDENCIES enzyme)
endif()
...
list(APPEND PALACE_OPTIONS
  ...
  "-DPALACE_WITH_ENZYME=${PALACE_WITH_ENZYME}"
...
if(PALACE_WITH_ENZYME)
  list(APPEND PALACE_OPTIONS "-DLLVM_DIR=${LLVM_DIR}")
  if(NOT "${ENZYME_DIR}" STREQUAL "")
    list(APPEND PALACE_OPTIONS "-DENZYME_DIR=${ENZYME_DIR}")
  endif()
endif()
