...
if("${PALACE_BUILD_SYSTEM}" STREQUAL "")
  set(PALACE_BUILD_SYSTEM "CMake superbuild")
endif()
...
list(APPEND PALACE_OPTIONS
  ...
  "-DPALACE_BUILD_SYSTEM=${PALACE_BUILD_SYSTEM}"
  "-DPALACE_BUILD_ID=${PALACE_BUILD_ID}"
  "-DPALACE_DEPENDENCY_MANIFEST=${PALACE_DEPENDENCY_MANIFEST}"
...
# Without a producer manifest, external dependencies are not a reliable indication that a
# libCEED backend was selected. Only the bundled superbuild passes these selections through.
if(PALACE_BUILD_EXTERNAL_DEPS)
  list(APPEND PALACE_OPTIONS
    "-DPALACE_WITH_LIBXSMM=${PALACE_WITH_LIBXSMM}"
    "-DPALACE_WITH_MAGMA=${PALACE_WITH_MAGMA}")
else()
  list(APPEND PALACE_OPTIONS
...
if(NOT "${LIBCEED_DIR}" STREQUAL "")
  list(APPEND PALACE_OPTIONS "-DLIBCEED_DIR=${LIBCEED_DIR}")
elseif(PALACE_BUILD_EXTERNAL_DEPS)
  list(APPEND PALACE_OPTIONS "-DLIBCEED_DIR=${CMAKE_INSTALL_PREFIX}")
endif()
...
if(NOT "${SCALAPACK_DIR}" STREQUAL "")
  list(APPEND PALACE_OPTIONS "-DSCALAPACK_DIR=${SCALAPACK_DIR}")
endif()
if(PALACE_BUILD_EXTERNAL_DEPS AND PALACE_WITH_SUNDIALS)
  list(APPEND PALACE_OPTIONS "-DSUNDIALS_DIR=${CMAKE_INSTALL_PREFIX}")
endif()
if(NOT "${GSLIB_DIR}" STREQUAL "")
  list(APPEND PALACE_OPTIONS "-DGSLIB_DIR=${GSLIB_DIR}")
elseif(PALACE_BUILD_EXTERNAL_DEPS AND PALACE_WITH_GSLIB)
...
if(PALACE_WITH_CUDA)
  ...
  palace_append_cuda_architectures(PALACE_OPTIONS)
else()
  list(APPEND PALACE_OPTIONS
