...
TEST_CASE_METHOD(palace::test::SharedTempDir, "SaveIteration moves files and leaves symlinks",
                 "[basesolver][Serial]")
{
...
TEST_CASE_METHOD(palace::test::SharedTempDir,
                 "SaveIteration handles directories",
                 "[basesolver][Serial]")
{
  MPI_Comm comm = MPI_COMM_WORLD;
...
TEST_CASE_METHOD(palace::test::SharedTempDir,
                 "SaveIteration handles two consecutive iterations",
                 "[basesolver][Serial]")
{
  MPI_Comm comm = MPI_COMM_WORLD;
...
TEST_CASE_METHOD(palace::test::SharedTempDir,
                 "SaveIteration skips iteration subfolders",
                 "[basesolver][Serial]")
{
  MPI_Comm comm = MPI_COMM_WORLD;
