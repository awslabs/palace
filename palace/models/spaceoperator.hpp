...
public:
  ...
  template <typename OperType, typename ScalarType>
  std::unique_ptr<OperType> GetPreconditionerMatrix(ScalarType a0, ScalarType a1, ScalarType a2,
                                                    double a3);
  //std::unique_ptr<ComplexOperator> GetPreconditionerMatrix(std::complex<double> a0, std::complex<double> a1, std::complex<double> a2,
  //                                                  double a3);
