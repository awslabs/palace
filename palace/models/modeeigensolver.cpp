                                                    ...
                                                    const ComplexVector *initial_space)
{
  ...
  if (block_pc_ptr)
  {
    ...
    // The preconditioner is a real-arithmetic approximation built at Re(omega); for
    // complex omega the imaginary operator parts are dropped here (correctness comes
    // from the full complex opA — this only affects GMRES iteration counts).
