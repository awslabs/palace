    ...
    kc(1.0 / units.Dimensionalize<Units::ValueType::LENGTH>(1.0))
{
  ...
  // impedance/conductivity/absorbing BC support). Use the IoData constructor when wave ports
  // are configured. This constructor is used by SpaceOperator when delegating from the IoData
  // constructor; the IoData path reconstructs wave_port_op afterwards.
