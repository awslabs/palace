...
CEED_QFUNCTION_HELPER void MultAtBCx21(const CeedScalar A[2], const CeedScalar alpha,
                                       ...
                                       CeedScalar y[1])
{
  ...
  y[0] = alpha * x[0] * (A[0] * C[0] + A[1] * C[1]);
}

CEED_QFUNCTION_HELPER void MultBAx21(const CeedScalar A[2], const CeedScalar alpha,
...
CEED_QFUNCTION_HELPER void MultAtBA21(const CeedScalar A[2], const CeedScalar alpha,
                                      CeedScalar C[1])
{
  // A: 0   alpha   C: 0
  //    1
...
CEED_QFUNCTION_HELPER void MultAtBC21(const CeedScalar A[2], const CeedScalar alpha,
...
CEED_QFUNCTION_HELPER void MultBA21(const CeedScalar A[2], const CeedScalar alpha,
                                    CeedScalar C[2])
{
  // A: 0   alpha   C: 0
  //    1              1
