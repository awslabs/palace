...
#ifndef PALACE_FEM_MATERIAL_OPERATOR_HPP
#define PALACE_FEM_MATERIAL_OPERATOR_HPP
...
{
private:
  // Spatial dimension of the input mesh. Returned DenseMatrix objects are sdim x sdim.
  const int sdim;
...
public:
  MaterialOperator(const IoData &iodata, const mfem::ParMesh &mesh);
...
#endif  // PALACE_FEM_MATERIAL_OPERATOR_HPP
