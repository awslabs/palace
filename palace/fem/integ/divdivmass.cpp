                                    ...
                                    CeedBasis test_basis, CeedOperator *op) const
{
  ...
  {
    case 22:
      info.apply_qf = assemble_qdata ? f_build_l2mass_22 : f_apply_l2mass_22;
      info.apply_qf_path = PalaceQFunctionRelativePath(
          assemble_qdata ? f_build_l2mass_22_loc : f_apply_l2mass_22_loc);
      break;
    case 33:
      info.apply_qf = assemble_qdata ? f_build_l2mass_33 : f_apply_l2mass_33;
      info.apply_qf_path = PalaceQFunctionRelativePath(
          assemble_qdata ? f_build_l2mass_33_loc : f_apply_l2mass_33_loc);
      break;
    case 21:
      info.apply_qf = assemble_qdata ? f_build_l2mass_21 : f_apply_l2mass_21;
      info.apply_qf_path = PalaceQFunctionRelativePath(
          assemble_qdata ? f_build_l2mass_21_loc : f_apply_l2mass_21_loc);
      break;
    case 32:
      info.apply_qf = assemble_qdata ? f_build_l2mass_32 : f_apply_l2mass_32;
      info.apply_qf_path = PalaceQFunctionRelativePath(
          assemble_qdata ? f_build_l2mass_32_loc : f_apply_l2mass_32_loc);
      break;
    default:
