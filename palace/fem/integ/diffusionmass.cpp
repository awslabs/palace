                                       ...
                                       CeedOperator *op) const
{
  ...
  {
    case 22:
      info.apply_qf = assemble_qdata ? f_build_hcurlmass_22 : f_apply_hcurlmass_22;
      info.apply_qf_path = PalaceQFunctionRelativePath(
          assemble_qdata ? f_build_hcurlmass_22_loc : f_apply_hcurlmass_22_loc);
      break;
    case 33:
      info.apply_qf = assemble_qdata ? f_build_hcurlmass_33 : f_apply_hcurlmass_33;
      info.apply_qf_path = PalaceQFunctionRelativePath(
          assemble_qdata ? f_build_hcurlmass_33_loc : f_apply_hcurlmass_33_loc);
      break;
    case 21:
      info.apply_qf = assemble_qdata ? f_build_hcurlmass_21 : f_apply_hcurlmass_21;
      info.apply_qf_path = PalaceQFunctionRelativePath(
          assemble_qdata ? f_build_hcurlmass_21_loc : f_apply_hcurlmass_21_loc);
      break;
    case 32:
      info.apply_qf = assemble_qdata ? f_build_hcurlmass_32 : f_apply_hcurlmass_32;
      info.apply_qf_path = PalaceQFunctionRelativePath(
          assemble_qdata ? f_build_hcurlmass_32_loc : f_apply_hcurlmass_32_loc);
      break;
    default:
  ...
  auto ctx = [&]()
  {
    ...
    {
      case 2:
        return ceed::PopulateCoefficientContext<2, 1>(Q, Q_mass);
      case 3:
        return ceed::PopulateCoefficientContext<3, 1>(Q, Q_mass);
    }
