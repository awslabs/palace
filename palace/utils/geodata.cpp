...
std::map<int, std::array<int, 2>> CheckMesh(mfem::Mesh &, const IoData &, bool, bool, bool,
                                            const int *);
                                        ...
                                        bool clean_elem, bool add_bdr, bool add_subdomain)
{
  ...
  if (Mpi::Root(comm) || !use_mesh_partitioner)
  {
    ...
    {
      static_cast<void>(CheckMesh(*smesh, iodata, false, false, true, partitioning.get()));
    }
  }
...
std::map<int, std::array<int, 2>> CheckMesh(mfem::Mesh &orig_mesh, const IoData &iodata,
                                            ...
                                            bool add_subdomain, const int *partitioning)
{
...
void RebalanceConformalMesh(mfem::ParMesh &pmesh)
{
  ...
  auto new_pmesh = DistributeMesh(comm, smesh, partitioning.get());
