...
function(check_petsc_build _petsc_target _petsc_test_success _petsc_test_error)
...
")
  ...
  if(PETSC_TEST_COMPILED AND PETSC_TEST_EXITCODE EQUAL 0)
    ...
    if(NOT PETSC_TEST_COMPILED)
      set(${_petsc_test_error} "${PETSC_TEST_COMPILE_OUTPUT}" PARENT_SCOPE)
    else()
      set(${_petsc_test_error} "${PETSC_TEST_OUTPUT}" PARENT_SCOPE)
    endif()
...
function(find_petsc_pkgconfig _petsc_deps _petsc_target)
  ...
  check_petsc_build("PkgConfig::PETSc;${_petsc_deps}" PETSC_TEST_SUCCESS PETSC_TEST_ERROR)
  ...
  set(PKG_CONFIG_EXECUTABLE ${PKG_CONFIG_EXECUTABLE_BACKUP})
  if(NOT PETSc_STATIC_FOUND)
    message(STATUS "PETSc test program output:\n${PETSC_TEST_ERROR}")
    set(${_petsc_target} "" PARENT_SCOPE)
    return()
  endif()
  check_petsc_build("PkgConfig::PETSc_STATIC;${_petsc_deps}" PETSC_STATIC_TEST_SUCCESS PETSC_STATIC_TEST_ERROR)
  if(PETSC_STATIC_TEST_SUCCESS)
    message(STATUS "PETSc test program with static linkage - Success")
    set(${_petsc_target} PkgConfig::PETSc_STATIC PARENT_SCOPE)
    return()
  endif()

  # Not able to build a PETSc test program with either linkage
  message(STATUS "PETSc test program with static linkage - Failed")
  message(STATUS "PETSc shared linkage output:\n${PETSC_TEST_ERROR}")
  message(STATUS "PETSc static linkage output:\n${PETSC_STATIC_TEST_ERROR}")
  set(${_petsc_target} "" PARENT_SCOPE)
endfunction()

function(check_slepc_build _slepc_target _slepc_test_success _slepc_test_error)
...
")
  ...
  if(SLEPC_TEST_COMPILED AND SLEPC_TEST_EXITCODE EQUAL 0)
    ...
    if(NOT SLEPC_TEST_COMPILED)
      set(${_slepc_test_error} "${SLEPC_TEST_COMPILE_OUTPUT}" PARENT_SCOPE)
    else()
      set(${_slepc_test_error} "${SLEPC_TEST_OUTPUT}" PARENT_SCOPE)
    endif()
...
function(find_slepc_pkgconfig _slepc_deps _slepc_target)
  ...
  check_slepc_build("PkgConfig::SLEPc;${_slepc_deps}" SLEPC_TEST_SUCCESS SLEPC_TEST_ERROR)
  ...
  set(PKG_CONFIG_EXECUTABLE ${PKG_CONFIG_EXECUTABLE_BACKUP})
  if(NOT SLEPc_STATIC_FOUND)
    message(STATUS "SLEPc test program output:\n${SLEPC_TEST_ERROR}")
    set(${_slepc_target} "" PARENT_SCOPE)
    return()
  endif()
  check_slepc_build("PkgConfig::SLEPc_STATIC;${_slepc_deps}" SLEPC_STATIC_TEST_SUCCESS SLEPC_STATIC_TEST_ERROR)
  if(SLEPC_STATIC_TEST_SUCCESS)
    message(STATUS "SLEPc test program with static linkage - Successful")
    set(${_slepc_target} PkgConfig::SLEPc_STATIC PARENT_SCOPE)
    return()
  endif()

  # Not able to build a SLEPc test program with either linkage
  message(STATUS "SLEPc test program with static linkage - Failed")
  message(STATUS "SLEPc shared linkage output:\n${SLEPC_TEST_ERROR}")
  message(STATUS "SLEPc static linkage output:\n${SLEPC_STATIC_TEST_ERROR}")
  set(${_slepc_target} "" PARENT_SCOPE)
endfunction()
