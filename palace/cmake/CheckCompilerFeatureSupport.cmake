...
")
  ...
  if(STD_FS_TEST_COMPILED AND STD_FS_TEST_EXITCODE EQUAL 0)
    ...
    if(NOT STD_FS_TEST_COMPILED)
      message(STATUS "std::filesystem test compile output: ${STD_FS_TEST_COMPILE_OUTPUT}")
    else()
      message(STATUS "std::filesystem test run output: ${STD_FS_TEST_OUTPUT}")
    endif()
